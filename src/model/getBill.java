...
public class getBill {
    ...
    public getBill(String bill_No, Date date, String time, Double part_Cost, Double mechanic_Cost, Double discount, Double amount, String user_Id, String booking_Id) {
